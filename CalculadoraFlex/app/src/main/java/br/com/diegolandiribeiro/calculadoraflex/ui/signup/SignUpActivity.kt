package br.com.diegolandiribeiro.calculadoraflex.ui.signup
...
import br.com.diegolandiribeiro.calculadoraflex.model.User
        ...
        FirebaseDatabase.getInstance().getReference("Users")
            ...
            .addOnCompleteListener{
                if(it.isSuccessful){
                    ...
                    Toast.makeText(this,"Erro ao criar o usuário",
                        Toast.LENGTH_SHORT).show()
                }
            }
    }
